...
class ClothingstoreApplicationTests {
	...
	void addProductToUserCart() {
		 ...
		 * : com.ics499.clothingstore.model.CartItem; nested exception is org.hibernate.InstantiationException: 
		 * No default constructor for entity:  : com.ics499.clothingstore.model.CartItem
		 */
